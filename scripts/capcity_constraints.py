...
model_name_to_model_print = {
    "FreqWeightedHSActivity": "Fauna-search",
    "FreqWeightedHSActivity_recoverablefeatures": "Fauna-search with recoverable features",
    "FreqWeightedHSActivity_recoverableweights": "Fauna-search with recoverable weights",
   
    # "FreqWeightedHSActivity_L101": "Fauna-search with L1 reg. λ = 0.1",
    "FreqWeightedHSActivity_L1001": "Fauna-search with L1 reg. λ = 1e-02",
    "FreqWeightedHSActivity_L10001": "Fauna-search with L1 reg. λ = 1e-03",
    "FreqWeightedHSActivity_L100001": "Fauna-search with L1 reg. λ = 1e-04",
    "FreqWeightedHSActivity_L1000001": "Fauna-search with L1 reg. λ = 1e-05",

     # "FreqWeightedHSActivity_L201": "Fauna-search with L2 reg. λ = 0.1",
    "FreqWeightedHSActivity_L2001": "Fauna-search with L2 reg. λ = 1e-02",
    "FreqWeightedHSActivity_L20001": "Fauna-search with L2 reg. λ = 1e-03",
    "FreqWeightedHSActivity_L200001": "Fauna-search with L2 reg. λ = 1e-04",
    "FreqWeightedHSActivity_L2000001": "Fauna-search with L2 reg. λ = 1e-05",
}
